...
<div class="row mb-4">
    <div class="col-12">
        <h4 class="py-3 mb-0"><span class="text-muted fw-light">Admin /</span> Edit Post</h4>
        <p class="text-muted small">Update your blog post</p>
    </div>
</div>
        ...
        <form action="{{ route('admin.posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div id="dropZone" class="border-2 border-dashed rounded p-4 text-center" style="cursor: pointer; transition: all 0.3s;">
                    ...
                    <div id="dropZoneContent">
                        @if($post->featured_image)
                            <img src="{{ asset('storage/' . $post->featured_image) }}" alt="Featured" style="width: 150px; height: 150px; margin: 0 auto 1rem; border-radius: 0.25rem; object-fit: cover;">
                        @else
                        ...
                        <div class="mt-2">
                            <label for="featured_image" class="form-label text-primary" style="cursor: pointer; margin-bottom: 0;">
                                <u>{{ $post->featured_image ? 'Click to change or drag new image' : 'Click to upload or drag image' }}</u>
                            </label>
                        </div>
            ...
            <div class="pt-3 border-top">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bx bx-check me-1"></i> Update Post
                </button>
            </div>
        </form>
    </div>
