...
<div class="row mb-4">
    <div class="col-12">
        <h4 class="py-3 mb-0"><span class="text-muted fw-light">Admin /</span> Edit Product</h4>
        ...
        <form method="POST" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="viscosity_grade" class="form-control @error('viscosity_grade') is-invalid @enderror" value="{{ old('viscosity_grade', $product->viscosity_grade) }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="short_description" rows="3" class="form-control @error('short_description') is-invalid @enderror">{{ old('short_description', $product->short_description) }}</textarea>
            ...
            <div class="col-md-6">
                ...
                @if($product->image_path)
                    <div class="mb-3">
                        ...
                        <div class="border rounded p-3 bg-light">
                            <img src="{{ asset('storage/' . $product->image_path) }}" alt="{{ $product->name }}" style="max-height: 150px; border-radius: 0.25rem;">
                            <p class="text-muted small mt-2 mb-0">{{ basename($product->image_path) }}</p>
                        </div>
                    </div>
                @endif
                ...
                @if($product->tds_pdf)
                    <div class="mb-3">
                        <p class="form-label">Current TDS</p>
                        <div class="border rounded p-3 bg-light">
                            <a href="{{ asset('storage/' . $product->tds_pdf) }}" target="_blank" class="text-primary text-decoration-none small">
                                <i class="bx bx-file"></i> {{ basename($product->tds_pdf) }}
                            </a>
                        </div>
                    </div>
                @endif
                ...
                <!-- TDS PDF -->
                <div class="mb-3">
                    <label class="form-label">{{ $product->tds_pdf ? 'Replace TDS PDF' : 'Technical Data Sheet (TDS) PDF' }}</label>
                ...
                @if($product->msds_pdf)
                    <div class="mb-3">
                        <p class="form-label">Current MSDS</p>
                        <div class="border rounded p-3 bg-light">
                            <a href="{{ asset('storage/' . $product->msds_pdf) }}" target="_blank" class="text-danger text-decoration-none small">
                                <i class="bx bx-file"></i> {{ basename($product->msds_pdf) }}
                            </a>
                        </div>
                    </div>
                @endif
                ...
                <!-- MSDS PDF -->
                <div class="mb-3">
                    <label class="form-label">{{ $product->msds_pdf ? 'Replace MSDS PDF' : 'Material Safety Data Sheet (MSDS) PDF' }}</label>
        ...
        <!-- Full Width Fields -->
            <div class="col-12 pt-4 border-top">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="specifications" rows="4" class="form-control @error('specifications') is-invalid @enderror">{{ old('specifications', $product->specifications) }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="applications" rows="4" class="form-control @error('applications') is-invalid @enderror">{{ old('applications', $product->applications) }}</textarea>
                    @error('applications')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="pack_sizes" class="form-control @error('pack_sizes') is-invalid @enderror" value="{{ old('pack_sizes', is_array($product->pack_sizes) ? implode(', ', $product->pack_sizes) : '') }}">
                        ...
                        @foreach($industries as $industry)
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input type="checkbox" name="industries[]" value="{{ $industry->id }}" id="industry-{{ $industry->id }}" class="form-check-input" @if(in_array($industry->id, $selectedIndustries)) checked @endif>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-check">
                            ...
                            <input type="checkbox" name="is_active" value="1" id="is_active" class="form-check-input" @if($product->is_active) checked @endif>
                    ...
                    <div class="col-md-6">
                        <div class="form-check">
                            ...
                            <input type="checkbox" name="is_featured" value="1" id="is_featured" class="form-check-input" @if($product->is_featured) checked @endif>
