                    ...
                    <div class="col-sm-7 col-md-6">
                        <div class="topbar-right">
                            ...
                            <ul class="topbar-sosmed">
                                ...
                                <li><a href="{{ $linkedinUrl }}"><i class="fa fa-pinterest"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="topbar-logo">
            <div class="container">
                <div class="contact-info">
                    ...
                    <!-- INFO 3 -->
                    <a href="{{ route('contact.show') }}" title="" class="btn btn-cta pull-right">GET A QUOTE</a>
                </div>
            </div>
        </div>
                    ...
                    <nav class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li class="dropdown {{ Request::routeIs('services.index') ? 'active' : '' }}">
                                <a href="{{ route('services.index') }}" title="Services">SERVICES</a>
                            </li>
                            <li class="dropdown {{ Request::routeIs('products.index', 'products.by-category') ? 'active' : '' }}">
                                <a href="{{ route('products.index') }}" data-toggle="dropdown" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false" title="Products">PRODUCTS <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    @foreach($categories as $cat)
                                    <li><a href="{{ route('products.by-category', $cat->slug) }}">{{ strtoupper($cat->name) }}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                            ...
                            <li class="dropdown {{ Request::routeIs('contact.show', 'contact.store') ? 'active' : '' }}">
                                <a href="{{ route('contact.show') }}" title="Contact Us">CONTACT</a>
                            </li>
                        </ul>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="widget">
                        ...
                        <p>Union Lubricants - Providing quality industrial lubricants since 1983.</p>
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="widget">
                        ...
                        <ul class="widget-post">
                            ...
                            <li><a href="{{ route('news.show', $post->slug) }}">{{ $post->title }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="widget">
                        ...
                        <ul class="widget-services">
                            ...
                            <li><a href="{{ route('services.index') }}#{{ $service->id }}">{{ $service->title }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="copyright">
                            <p>&copy; 2024 Union Lubricants. All Rights Reserved.</p>
                        </div>
                    </div>
                    <div class="col-sm-6">
...
<!-- INFO BOX -->
			...
			<div class="row">
				<div class="col-sm-3 col-md-3">
					<div class="footer-item">
						<img src="{{ asset('frontend/images/logo-light.png') }}" alt="Union Lubricants" style="max-width: 180px; margin-bottom: 15px;">
				...
				<div class="col-sm-3 col-md-3">
					<div class="footer-item">
						...
						<ul class="list">
							...
							<li><a href="{{ route('products.index') }}" title="">Products</a></li>
							<li><a href="{{ route('news.index') }}" title="">Blog</a></li>
				...
				<div class="col-sm-3 col-md-3">
					<div class="footer-item">
						...
						<ul class="list">
							<li><a href="{{ route('products.index') }}" title="">Engine Oils</a></li>
							<li><a href="{{ route('products.index') }}" title="">Industrial Oils</a></li>
							<li><a href="{{ route('products.index') }}" title="">Hydraulic Fluids</a></li>
							<li><a href="{{ route('products.index') }}" title="">Coolants</a></li>
							<li><a href="{{ route('products.index') }}" title="">Specialty Lubricants</a></li>
							<li><a href="{{ route('products.index') }}" title="">Greases</a></li>
						</ul>
					</div>
				</div>
				<div class="col-sm-3 col-md-3">
						...
						<ul class="list" style="list-style: none; padding: 0;">
							<li style="margin-bottom: 12px;">
                                     ...
                                     <i class="fa fa-phone" style="color: #0054a6; margin-right: 8px;"></i>
                                        <a href="tel:{{ $phone }}" title="">{{ $phone }}</a><br>
                                    @endforeach
							</li>
							<li style="margin-bottom: 12px;">
								<i class="fa fa-envelope" style="color: #0054a6; margin-right: 8px;"></i>
									<a href="mailto:{{ $companyEmail }}" title="">{{ $companyEmail }}</a>
							</li>
							<li style="margin-bottom: 12px;">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12">
					<p class="ftex">&copy; {{ date('Y') }} Union Lubricants. All Rights Reserved. | <a href="#" style="color: inherit;">Privacy Policy</a> | <a href="#" style="color: inherit;">Terms & Conditions</a></p>
				</div>
			</div>
		</div>
	</div>	</div>
    ...
    <script type="text/javascript" src="{{ asset('frontend/js/vendor/jquery.counterup.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('frontend/js/vendor/waypoints.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('frontend/js/vendor/isotope.pkgd.min.js') }}"></script>
