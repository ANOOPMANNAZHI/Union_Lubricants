<!DOCTYPE html>
<html lang="en" class="layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-skin="default" data-assets-path="{{ asset('admin/assets/') }}" data-template="vertical-menu-template" data-bs-theme="light">
<head>
    <meta charset="UTF-8" />
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu">
                <div class="app-brand demo">
                    <a href="/admin/dashboard" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <img src="{{ asset('logo.jpg') }}" alt="Union Lubricants Logo" style="height: 40px; width: auto;">
                        </span>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- eCommerce -->
                    <li class="menu-item {{ Request::routeIs('admin.products.*', 'admin.categories.*', 'admin.industries.*', 'admin.brands.*') ? 'active open' : '' }}">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{ Request::routeIs('admin.industries.*') ? 'active' : '' }}">
                    ...
                    <!-- Content -->
                    <li class="menu-item {{ Request::routeIs('admin.posts.*', 'admin.about.*', 'admin.certifications.*', 'admin.testimonials.*', 'admin.services.*') ? 'active open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{ Request::routeIs('admin.certifications.*') ? 'active' : '' }}">
                    ...
                    <!-- Product Catalogs -->
                    <li class="menu-item {{ Request::routeIs('admin.catalogs.*') ? 'active' : '' }}">
                    ...
                    <div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    <form action="{{ route('logout') }}" method="POST" id="navbar-logout-form" style="display: inline;">
                                        @csrf
