	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-12">
				<div class="title-page">Our Products</div>
				<ol class="breadcrumb">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-md-4 col-md-push-8">
				...
				<div class="widget categories">
					...
					@else
					<li class="active"><a href="{{ route('products.index') }}">All Products</a></li>
					@endif
				</div>
			...
			<div class="col-sm-8 col-md-8 col-md-pull-4">
				<div class="products-list">
					<h2 class="section-heading" style="padding-bottom: 0;">Our Complete Product Range</h2>
					{{-- <p class="section-subheading">Premium quality lubricants for all industrial applications</p> --}}
