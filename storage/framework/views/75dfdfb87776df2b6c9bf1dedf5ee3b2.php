<?php $__env->startSection('title', $product->name . ' - Union Lubricants'); ?>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-12">
				<div class="title-page"><?php echo e($product->name); ?></div>
				<ol class="breadcrumb">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-md-4 col-md-push-8">
				...
				<div class="widget categories">
					...
					<ul class="category-nav">
						...
						<li <?php if($product->category_id === $cat->id): ?> class="active" <?php endif; ?>>
				...
				<div class="widget download">
					<?php if($product->tds_pdf): ?>
					<a href="<?php echo e(asset('storage/' . $product->tds_pdf)); ?>" target="_blank" class="btn btn-secondary btn-block btn-sidebar" style="margin-bottom: 10px;">
						<span class="fa fa-file-pdf-o"></span> Download TDS
					</a>
					<?php endif; ?>
					<?php if($product->msds_pdf): ?>
					<a href="<?php echo e(asset('storage/' . $product->msds_pdf)); ?>" target="_blank" class="btn btn-secondary btn-block btn-sidebar" style="margin-bottom: 10px;">
			...
			<div class="col-sm-8 col-md-8 col-md-pull-4">
				<div class="single-page">
					...
					<?php else: ?>
					<img src="<?php echo e(asset('images/800x500.jpg')); ?>" alt="<?php echo e($product->name); ?>" class="img-responsive">
					<?php endif; ?>
					...
					<p class="section-subheading">
						...
						<a href="<?php echo e(route('products.by-category', $product->category->slug)); ?>" style="color: #0054a6;">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="block-title text-center">
					...
					<p>Other products in the <?php echo e($product->category->name ?? 'same category'); ?></p>
				</div>
			</div>
		</div>

		<div class="row">
			<?php $__currentLoopData = $relatedProducts->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="col-md-4 col-sm-6">
				<div class="feature-box-8">
					<div class="media">
						<?php if($related->image_path): ?>
						<img src="<?php echo e(asset('storage/' . $related->image_path)); ?>" alt="<?php echo e($related->name); ?>" class="img-responsive">
						<?php else: ?>
						<img src="<?php echo e(asset('images/600x400.jpg')); ?>" alt="<?php echo e($related->name); ?>" class="img-responsive">
						<?php endif; ?>
					</div>
					<div class="body">
						<a href="<?php echo e(route('products.show', $related->slug)); ?>" class="title"><?php echo e($related->name); ?></a>
						<p><?php echo e(Str::limit($related->description, 100)); ?></p>
						<a href="<?php echo e(route('products.show', $related->slug)); ?>" class="readmore">VIEW DETAILS</a>
					</div>
				</div>
			</div>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\union\union_lubricants\union_lubricants\resources\views/frontend/products/show.blade.php ENDPATH**/ ?>